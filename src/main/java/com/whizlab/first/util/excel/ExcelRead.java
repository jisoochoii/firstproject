...
public class ExcelRead {
	public static List<Map<String, String>> readExcel(ExcelReadOption excelReadOption) throws Exception {
		// 엑셀 파일 자체
		// 엑셀파일을 읽어 들인다.
		...
		int numOfRows = sheet.getPhysicalNumberOfRows(); // 시트의 수를 가져오기 위한 변수
		int numOfCells = 0;
