    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12 text-right">
                <a class="btn btn-primary float-right" id="write" href="${pageContext.request.contextPath}/writeNotice">글쓰기</a>
            </div>
        </div>
        <div id="data-table-default_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
            <table id="dataTable2" class="table table-striped table-bordered dataTable no-footer dtr-inline collapsed"
                ...
                <tbody>
                <c:forEach var="fb"  items="${noticeList}">
                    <tr onclick="location.href='/viewNotice?fbSeq=${fb.fbSeq}'">
                        <td >
